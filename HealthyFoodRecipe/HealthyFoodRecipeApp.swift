        ...
        do {
            ...
            let recipes: [Recipe] = [
                ...
                Recipe(
                    ...
                    category: Category(name: "Дессерты", image: "dessert"),
                    isFavorite: false,
                    menuItems: []
                ),
                Recipe(
                ...
                Recipe(
                    ...
                    category: Category(name: "Выпечки", image: "baking"),
                    isFavorite: false,
                    menuItems: []
                ),
                Recipe(
                    ...
                    category: Category(name: "Аппетайзер", image: "appetizer"),
                    isFavorite: false,
                    menuItems: []
                ),
                Recipe(
                    ...
                    category: Category(name: "Гарниры", image: "garnish"),
                    isFavorite: false,
                    menuItems: []
                ),
                Recipe(
